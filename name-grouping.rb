...
puts "Enter the number of groups to create: "
group_input = gets.chomp.to_i
group_number = Array.new(group_input) { [] }
...
while true do
  ...
  if name == "stop"
    ...
    group_number[counter] << name
    counter += 1
  end
  if counter == group_input
    counter = 0
  end
end

while true do
  puts "Enter the group number to print: "
  input_group = gets.chomp
  if input_group == "stop"
    break
  else
    puts group_number[input_group.to_i - 1].join(", ")
  end
end
...
if name == "stop"
  break
elsif group_number == "stop"
  break
end

# ASK FOR USER INPUT PART 2
puts "Enter the group number you'd like to look up: "
puts
